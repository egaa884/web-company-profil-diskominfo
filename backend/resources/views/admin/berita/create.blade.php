                                ...
                                <div class="card border-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="deskripsi_singkat" id="deskripsi_singkat" class="form-control" rows="3" placeholder="Ringkasan singkat berita (opsional)" maxlength="300">{{ old('deskripsi_singkat') }}</textarea>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="file" name="gambar" id="gambar" class="form-control" accept="image/jpeg,image/jpg,image/png" onchange="validateImage(this)" required>
                                ...
                                <div class="card border-info">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="konten" id="konten" class="form-control" rows="12" required placeholder="Tulis isi berita di sini...">{{ old('konten') }}</textarea>
                                            <small class="text-muted">
                                                Minimal 30 karakter.
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="nama_pembuat" id="nama_pembuat" class="form-control" value="{{ old('nama_pembuat', 'Admin Diskominfo') }}" placeholder="Nama penulis">
                                            </div>
                                        </div>
                                    </div>
                                </div>
