...
@section('title', 'Tambah Laporan Pengaduan')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Tambah Laporan Pengaduan Baru</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.laporan-pengaduan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('kategori_pengaduan') is-invalid @enderror" 
                                        ...
                                        <option value="Pelayanan Publik" {{ old('kategori_pengaduan') == 'Pelayanan Publik' ? 'selected' : '' }}>Pelayanan Publik</option>
                                        <option value="Infrastruktur" {{ old('kategori_pengaduan') == 'Infrastruktur' ? 'selected' : '' }}>Infrastruktur</option>
                                        <option value="Administrasi" {{ old('kategori_pengaduan') == 'Administrasi' ? 'selected' : '' }}>Administrasi</option>
                                        <option value="Keamanan" {{ old('kategori_pengaduan') == 'Keamanan' ? 'selected' : '' }}>Keamanan</option>
                                        <option value="Kesehatan" {{ old('kategori_pengaduan') == 'Kesehatan' ? 'selected' : '' }}>Kesehatan</option>
                                        <option value="Pendidikan" {{ old('kategori_pengaduan') == 'Pendidikan' ? 'selected' : '' }}>Pendidikan</option>
                                        <option value="Transportasi" {{ old('kategori_pengaduan') == 'Transportasi' ? 'selected' : '' }}>Transportasi</option>
                                        <option value="Lingkungan" {{ old('kategori_pengaduan') == 'Lingkungan' ? 'selected' : '' }}>Lingkungan</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email_pelapor') is-invalid @enderror" 
                                           id="email_pelapor" name="email_pelapor" value="{{ old('email_pelapor') }}" required>
                                    @error('email_pelapor')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Format: PDF, DOC, DOCX, JPG, JPEG, PNG (Max: 2MB)</small>
                                    @error('file_lampiran')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('admin.laporan-pengaduan.index') }}" class="btn btn-secondary">
